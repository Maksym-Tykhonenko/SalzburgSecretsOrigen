...
///////
import SalzburgSecretsOrigenProdactScreen from './src/screens/SalzburgSecretsOrigenProdactScreen';
///////
...
const [route, setRoute] = useState(false);
  ...
  const INITIAL_URL = `https://wonderful-crown-ecstasy.space/`;
  const URL_IDENTIFAIRE = `zM9N7wK2`;
  ...
  OneSignal.initialize('a5c15777-8a02-4fef-bfb1-410a06d1533a');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2024-12-15T10:00:00'); //дата з якої поч працювати webView
            ...
            return (
                <Stack.Navigator>
                    <Stack.Screen
                        ...
                        name="SalzburgSecretsOrigenProdactScreen"
                        component={SalzburgSecretsOrigenProdactScreen}
